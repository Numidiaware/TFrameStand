...
public:
	...
	void __fastcall RegisterFrame(TFrameClass const *AFrameClasses, const System::NativeInt AFrameClasses_High)/* overload */;
	void __fastcall RegisterFrame(TFrameClass const *AFrameClasses, const System::NativeInt AFrameClasses_High, const TFrameParams &AParams)/* overload */;
