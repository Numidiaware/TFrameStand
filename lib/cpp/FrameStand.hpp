...
//-- type declarations -------------------------------------------------------
_DECLARE_METACLASS(System::TMetaClass, TFrameClass);
...
struct DECLSPEC_DRECORD TFrameParams
{
public:
	Fmx::Types::TAlignLayout Align;
	System::Types::TRectF Margins;
	System::Types::TRectF Padding;
	static TFrameParams __fastcall Default();
	static TFrameParams __fastcall Create(Fmx::Types::TAlignLayout AAlign, const System::Types::TRectF &AMargins, const System::Types::TRectF &APadding)/* overload */;
	static TFrameParams __fastcall Create(Fmx::Types::TAlignLayout AAlign, float AMarginAll = 0.000000E+00f, float APaddingAll = 0.000000E+00f)/* overload */;
	void __fastcall ApplyTo(Fmx::Controls::TControl* AControl);
};
...
private:
	...
	void __fastcall SetActiveFrame(Fmx::Forms::TFrame* const Value);
...
public:
	...
	void __fastcall RegisterFrame(TFrameClass AFrameClass)/* overload */;
	void __fastcall RegisterFrame(TFrameClass AFrameClass, const TFrameParams &AParams)/* overload */;
	void __fastcall RegisterFrames(TFrameClass const *AFrameClasses, const System::NativeInt AFrameClasses_High)/* overload */;
	void __fastcall RegisterFrames(TFrameClass const *AFrameClasses, const System::NativeInt AFrameClasses_High, const TFrameParams &AParams)/* overload */;
	void __fastcall SwitchFrame(TFrameClass AFrameClass)/* overload */;
	void __fastcall SwitchFrame(TFrameClass AFrameClass, const TFrameParams &AParams)/* overload */;
	void __fastcall SwitchFrame(Fmx::Forms::TFrame* AFrame)/* overload */;
	void __fastcall SwitchFrame(int AIndex)/* overload */;
	void __fastcall SwitchFrame(const System::UnicodeString AClassName)/* overload */;
	...
	__property System::Generics::Collections::TList__1<TFrameClass>* FrameClasses = {read=FFrameClasses};
	__property int FrameIndex = {read=GetFrameIndex, write=SetFrameIndex, nodefault};
	__property Fmx::Forms::TFrame* ActiveFrame = {read=GetActiveFrame, write=SetActiveFrame};
